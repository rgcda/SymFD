...
minFeatureWidth = 4; %positive real value, measured in pixels
...
alpha = 0.5; %real value between 0 and 1; alpha parameter, determines the degree of anistrophy with respect to scaling
...
SFDplotMap(featureMap,'auto','feature','Edge Measure',img);
